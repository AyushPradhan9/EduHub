...
export default class PathfindingVisualizer extends Component {
      ...
      {grid.map((row, rowIdx) => {
        return (
          ...
          {row.map((node, nodeIdx) => {
            ...
            else if(!((row==10 && col==5) || (row==10 && col==35)) && count>0)
            {
  ...
  render() {
    ...
    return (
      <div id="main">
      <Button size="small" disabled={this.state.disabled} onClick={()=>this.startVisualization()} id="btno">
        Start Visualization
      </Button>
      <Button size="small" disabled={this.state.disabled} onClick={() => this.rM()} id="btnt">
      Reset Board
      </Button>
      <Button size="small" disabled={this.state.disabled} onClick={() => this.createVerticalMaze()} id="btnv">
      Create Vertical Maze
      </Button>
      <Button size="small" disabled={this.state.disabled} onClick={() => this.createHorizontalMaze()} id="btnh">
      Create Horizontal Maze
      </Button>
      <Button size="small" disabled={this.state.disabled} onClick={() => this.createRandomMaze()} id="btn5">
      Create Random Maze
      </Button>
      <hr></hr>
